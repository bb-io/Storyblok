...
public class SetStoryLanguageSlugStoryResponse
{
    ...
    [Display("Root folder")] public string RootFolder { get; set; }
    ...
    [Display("Translated slugs")] public List<TranslatedSlugEntity>? TranslatedSlugs { get; set; }
    [Display("Localized paths")] public List<LocalizedPathEntity>? LocalizedPaths { get; set; }
}
